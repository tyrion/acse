...
exp: NUMBER      { $$ = create_expression ($1, IMMEDIATE); }
   ...
   | exp MOD_OP exp     {
        if ($1.expression_type == IMMEDIATE &&
            ...
            t_axe_expression e1 = handle_bin_numeric_op(program, $1, $3, DIV);
            t_axe_expression e2 = handle_bin_numeric_op(program, e1, $3, MUL);
            $$ = handle_bin_numeric_op(program, $1, e2, SUB);
        }
   }
   | exp LT exp      {
